(function () {
  ...
  const dictionary = {
    ar: {
      ...
      cta_whatsapp: "تفاصيل أكثر",
      sticky_whatsapp: "واتساب",
      cta_call: "اتصال مباشر",
      whatsapp_general: "مرحبًا، أنا مهتم بمشروع هايسندا رأس الحكمة من بالم هيلز وأرغب في معرفة التفاصيل.",
      ...
      units_subtitle: "تواصل معنا مباشرة للحصول على أحدث التوافر والأسعار والخيارات المتاحة.",
      units_eoi_badge: "استشارة هاتفية مباشرة",
      units_cta_whatsapp: "تفاصيل أكثر",
      units_cta_eoi: "اتصل الآن",
      ...
      section_about_cta_eoi: "اتصل الآن",
    ...
    en: {
      ...
      units_subtitle: "Contact us directly for the latest availability, pricing, and unit options.",
      units_eoi_badge: "Direct phone consultation",
      units_cta_whatsapp: "More Details",
      units_cta_eoi: "Call Now",
      ...
      section_about_cta_eoi: "Call Now",
