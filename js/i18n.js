(function () {
  ...
  const dictionary = {
    ar: {
      ...
      nav_sec_projects: "المشاريع",
      nav_about: "من نحن",
      nav_privacy: "سياسة الخصوصية",
      nav_disclaimer: "اخلاء المسؤولية",
      lang_label: "EN",
      brand_sub: "منصة عقارية إعلامية مستقلة",
      footer_copy: "جميع الحقوق محفوظة - Palm Hills Projects",
      ...
      whatsapp_general: "مرحبًا، أنا مهتم بمشروعات Palm Hills وأرغب في معرفة التفاصيل.",
      whatsapp_general_hacienda: "مرحبًا، أنا مهتم بمشروع هايسندا رأس الحكمة من بالم هيلز وأرغب في معرفة التفاصيل.",
      whatsapp_general_badya: "مرحبًا، أنا مهتم بمشروع بادية من بالم هيلز وأرغب في معرفة الأسعار وخطط السداد.",
      ...
      form_phone_error: "من فضلك أدخل رقم هاتف صحيح بكود الدولة.",
      form_email: "البريد الإلكتروني",
      form_unit: "نوع الوحدة",
      form_unit_placeholder: "اختر نوع الوحدة",
      form_unit_error: "من فضلك اختر نوع الوحدة.",
      ...
      about_title: "من نحن",
      about_subtitle:
        "Compound Hub منصة إعلامية وتسويقية مستقلة متخصصة في عرض مشروعات Palm Hills، يمتلكها ويديرها المسوق العقاري محمود جمال فاروق أحمد عبدالباقي، وهدفنا مساعدتك على اختيار وحدة مناسبة لاحتياجك وميزانيتك بأقصى شفافية.",
      ...
      privacy_p7: "هذا الموقع (Compound Hub) عبارة عن منصة إعلامية وتسويقية مستقلة متخصصة في عرض وتسويق المشروعات العقارية، يمتلكها ويديرها المسوق العقاري محمود جمال فاروق أحمد عبدالباقي. جميع المعلومات المعروضة على الموقع بما في ذلك الأسعار والصور والمساحات ومواصفات الوحدات هي معلومات إرشادية وتسويقية وقد تخضع للتحديث أو التغيير في أي وقت دون إشعار مسبق.",
      ...
      units_price_disclaimer: "الأسعار وخطط السداد المعروضة إرشادية وقابلة للتغيير حسب توافر الوحدة وتحديثات المطور - تواصل معنا لتأكيد أحدث سعر.",
      page_disclaimer_note: "هذا الموقع صفحة تسويقية مستقلة يديرها مسوق عقاري مستقل، وهو عبارة عن منصة إعلامية وتسويقية لعرض مشروعات Palm Hills، وليس الموقع الرسمي للمطور. جميع الأسعار والصور والعروض إرشادية وقابلة للتغيير دون إشعار مسبق.",

      home_projects_title: "مشروعاتنا",
      home_projects_subtitle: "اختر المشروع اللي يهمك لعرض الوحدات والأسعار وخطط السداد.",
      home_project_hacienda_title: "هاسيندا رأس الحكمة",
      home_project_hacienda_teaser: "الوجهة الأضخم على الساحل الشمالي - Palm Hills.",
      home_project_badya_title: "بادية",
      home_project_badya_teaser: "أول مدينة ذكية ومستدامة في 6 أكتوبر - Palm Hills.",
      home_project_cta: "عرض المشروع",

      badya_nav_sec_payment: "خطط السداد",
      badya_home_kicker: "أكبر مشروعات Palm Hills",
      badya_home_title: "بادية Badya",
      badya_home_subtitle: "أول مدينة ذكية ومستدامة متكاملة في مصر - قلب مدينة 6 أكتوبر",
      badya_home_meta: "خصم يصل إلى 42% حتى وانت مقسط على 6 سنين",
      badya_hero_stat_1_t: "المساحة الإجمالية",
      badya_hero_stat_1_v: "3,000 فدان",
      badya_hero_stat_2_t: "تقسيط مرن",
      badya_hero_stat_2_v: "حتى 12 سنة",
      badya_hero_stat_3_t: "أقصى خصم",
      badya_hero_stat_3_v: "42%",
      badya_hero_stat_4_t: "الموقع",
      badya_hero_stat_4_v: "6 أكتوبر",
      badya_units_title: "وحدات بادية والأسعار المتاحة",
      badya_units_card_note: "ضمن أكبر مدينة متكاملة من Palm Hills",
      badya_units_type_apartments: "شقق سكنية",
      badya_units_type_townhouses: "تاون هاوس",
      badya_section_about_project_title: "لماذا بادية؟",
      badya_section_about_project_subtitle: "أول مدينة ذكية ومستدامة في مصر، في قلب مدينة 6 أكتوبر الجديدة.",
      badya_section_about_chip_1: "3,000 فدان",
      badya_section_about_chip_2: "أول مدينة ذكية ومستدامة",
      badya_section_about_chip_3: "+2,700 وحدة بالمرحلة الأولى",
      badya_section_about_chip_4: "15 دقيقة من وسط 6 أكتوبر",
      badya_section_about_feature_1_t: "تخطيط عالمي متكامل",
      badya_section_about_feature_1_p: "مدينة متكاملة تضم مجتمعات سكنية متنوعة ومنطقة تجارية وخدمية.",
      badya_section_about_feature_2_t: "جامعة بادية",
      badya_section_about_feature_2_p: "بالشراكة مع Taaleem وجامعة Maastricht الهولندية.",
      badya_section_about_feature_3_t: "موقع استراتيجي",
      badya_section_about_feature_3_p: "على طريق الواحات، يربط شرق وغرب القاهرة الكبرى.",
      badya_section_about_feature_4_t: "مدينة ذكية ومستدامة",
      badya_section_about_feature_4_p: "مبنية على فلسفة الوعي والذكاء والتواصل (Conscious, Cognitive, Connected).",
      badya_gallery_title: "جاليري بادية",
      badya_gallery_subtitle: "لمحة عن الحياة داخل أكبر مدينة متكاملة من Palm Hills.",
      badya_payment_title: "خطط السداد والخصومات",
      badya_payment_subtitle: "اختر خطة السداد المناسبة لك واحصل على خصم يصل إلى 42% حتى وانت بتقسط.",
      badya_payment_plan_1_t: "12 سنة",
      badya_payment_plan_1_p: "التقسيط الأطول لأقل التزام شهري.",
      badya_payment_plan_2_t: "10 سنوات",
      badya_payment_plan_2_p: "خصم 19% على السعر.",
      badya_payment_plan_3_t: "8 سنوات",
      badya_payment_plan_3_p: "خصم 30% على السعر.",
      badya_payment_plan_4_t: "6 سنوات",
      badya_payment_plan_4_p: "أعلى خصم متاح، يصل إلى 42% - وانت لسه بتقسط على 6 سنين.",
      badya_payment_best_value: "الأعلى توفيرًا",
      badya_payment_note: "الخصومات والأسعار قابلة للتغيير حسب توافر الوحدة - تواصل معنا لتأكيد أحدث عرض.",
      badya_form_subtitle: "فريق المبيعات المباشر جاهز للرد ومساعدتك في اختيار أفضل وحدة في بادية.",
      badya_form_submit: "إرسال وتواصل عبر واتساب",
      form_whatsapp_note: "✓ تم فتح واتساب في تابة جديدة - لو متفتحتش، دوس هنا للتواصل المباشر."
    },
    en: {
      nav_home: "Home",
      nav_sec_home: "Home",
      ...
      nav_sec_projects: "Projects",
      nav_about: "About Us",
      nav_privacy: "Privacy Policy",
      nav_disclaimer: "Disclaimer",
      lang_label: "AR",
      brand_sub: "Independent Real Estate Media Platform",
      footer_copy: "All rights reserved - Palm Hills Projects",
      ...
      cta_call: "Call Now",
      whatsapp_general: "Hello, I'm interested in Palm Hills projects and would like more details.",
      whatsapp_general_hacienda: "I'm interested in Hacienda Ras al Hekma Palm Hills, and I need more details.",
      whatsapp_general_badya: "Hello, I'm interested in Badya by Palm Hills and would like more details on pricing and payment plans.",
      ...
      form_phone_error: "Please enter a valid phone number with country code.",
      form_email: "Email Address",
      form_unit: "Unit Type",
      form_unit_placeholder: "Select unit type",
      form_unit_error: "Please choose a unit type.",
      ...
      about_subtitle:
        "Compound Hub is an independent real estate media and marketing platform showcasing Palm Hills projects, owned and managed by real estate marketer Mahmoud Gamal Farouk Ahmed Abdelbaky. Our goal is to help you choose the right unit for your needs and budget with full transparency.",
      ...
      privacy_p7: "This website (Compound Hub) is an independent informational and marketing platform specialized in presenting and marketing real estate projects, owned and managed by real estate marketer Mahmoud Gamal Farouk Ahmed Abdelbaky. All information displayed on the website, including prices, images, areas, and unit specifications, is for guidance and marketing purposes and may be updated or changed at any time without prior notice.",
      ...
      units_price_disclaimer: "Prices and payment plans shown are indicative and subject to change based on availability and developer updates - contact us to confirm the latest price.",
      page_disclaimer_note: "This page is an independent marketing landing page operated by an independent real estate broker. It is an informational and marketing platform showcasing Palm Hills projects and is not the developer's official website. All prices, images, and offers are indicative and subject to change without prior notice.",

      home_projects_title: "Our Projects",
      home_projects_subtitle: "Choose the project you're interested in to see units, prices, and payment plans.",
      home_project_hacienda_title: "Hacienda Ras El Hekma",
      home_project_hacienda_teaser: "The largest destination on Egypt's North Coast - Palm Hills.",
      home_project_badya_title: "Badya",
      home_project_badya_teaser: "Egypt's first smart, sustainable city in 6th of October - Palm Hills.",
      home_project_cta: "View Project",

      badya_nav_sec_payment: "Payment Plans",
      badya_home_kicker: "Palm Hills' Largest Project",
      badya_home_title: "Badya",
      badya_home_subtitle: "Egypt's First Smart, Sustainable Integrated City - Heart of 6th of October",
      badya_home_meta: "Up to 42% Discount - Even With 6-Year Installments",
      badya_hero_stat_1_t: "Total Area",
      badya_hero_stat_1_v: "3,000 Acres",
      badya_hero_stat_2_t: "Flexible Installments",
      badya_hero_stat_2_v: "Up to 12 Years",
      badya_hero_stat_3_t: "Maximum Discount",
      badya_hero_stat_3_v: "42%",
      badya_hero_stat_4_t: "Location",
      badya_hero_stat_4_v: "6th of October",
      badya_units_title: "Badya Units & Available Prices",
      badya_units_card_note: "Inside Palm Hills' largest integrated city",
      badya_units_type_apartments: "Apartments",
      badya_units_type_townhouses: "Townhouses",
      badya_section_about_project_title: "Why Badya?",
      badya_section_about_project_subtitle: "Egypt's first smart, sustainable city, in the heart of New 6th of October.",
      badya_section_about_chip_1: "3,000 Acres",
      badya_section_about_chip_2: "1st Smart & Sustainable City",
      badya_section_about_chip_3: "2,700+ Units in Phase 1",
      badya_section_about_chip_4: "15 Mins from October Center",
      badya_section_about_feature_1_t: "World-Class Masterplan",
      badya_section_about_feature_1_p: "A fully integrated city with diverse residential communities and a retail & services core.",
      badya_section_about_feature_2_t: "Badya University",
      badya_section_about_feature_2_p: "In partnership with Taaleem and Maastricht University.",
      badya_section_about_feature_3_t: "Strategic Location",
      badya_section_about_feature_3_p: "On Wahat Road, connecting East and West Greater Cairo.",
      badya_section_about_feature_4_t: "Smart & Sustainable City",
      badya_section_about_feature_4_p: "Built on the philosophy of Conscious, Cognitive, and Connected living.",
      badya_gallery_title: "Badya Gallery",
      badya_gallery_subtitle: "A glimpse into life inside Palm Hills' largest integrated city.",
      badya_payment_title: "Payment Plans & Discounts",
      badya_payment_subtitle: "Choose the plan that fits you and enjoy a discount of up to 42% - even while paying in installments.",
      badya_payment_plan_1_t: "12 Years",
      badya_payment_plan_1_p: "The longest installment plan for the lowest monthly commitment.",
      badya_payment_plan_2_t: "10 Years",
      badya_payment_plan_2_p: "19% discount on the price.",
      badya_payment_plan_3_t: "8 Years",
      badya_payment_plan_3_p: "30% discount on the price.",
      badya_payment_plan_4_t: "6 Years",
      badya_payment_plan_4_p: "Highest available discount, up to 42% - while still installing over 6 years.",
      badya_payment_best_value: "Best Value",
      badya_payment_note: "Discounts and prices are subject to change based on unit availability - contact us to confirm the latest offer.",
      badya_form_subtitle: "Our direct sales team is ready to help you choose the best-fit unit in Badya.",
      badya_form_submit: "Send & Chat on WhatsApp",
      form_whatsapp_note: "✓ WhatsApp opened in a new tab - didn't open? Click here to message us directly."
    }
  };
